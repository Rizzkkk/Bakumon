// Not decoration and not optional. 615 images and 155 descriptions are CC BY 4.0 and
// require attribution plus a licence link; removing this block puts the site outside the
// terms it is using the assets under. Cobblemon's asset policy also asks that use does not
// imply endorsement, which is what the last line is for - it is not filler.
// Exact wording: ground-truth/02-assets/attribution.md.
